...
import com.example.saba.finalproject.activity.ParentHome_Activity;


/**
 * A simple {@link Fragment} subclass.
 */
public class Fragment_parents extends Fragment implements View.OnClickListener {
    EditText name,passward;
    Button button_login;
    public Fragment_parents() {
    ...
    public void onClick(View v) {
        ...
        Intent intent=new Intent(getActivity(), ParentHome_Activity.class);
