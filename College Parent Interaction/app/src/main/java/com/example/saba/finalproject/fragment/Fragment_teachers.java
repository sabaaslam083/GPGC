...
import com.example.saba.finalproject.activity.TeachersHomeActivity;
 ...
 */
public class Fragment_teachers extends Fragment implements View.OnClickListener {
    EditText name,passward;
    Button button_login;
    public Fragment_teachers() {
    ...
    public void onClick(View v) {
        ...
        Intent intent=new Intent(getActivity(),TeachersHomeActivity.class);
